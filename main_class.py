...
class MainClass:
    ...
    def runTest(self, featureMapType = 0):
        ...
        print(f'main_class, n_qubits: {n_qubits}')
        ...
        score_original = MainClass.run_qsvm(x_padded, y, n_qubits, 1.0, featureMap, featureMapType)

        # score_scaled = MainClass.run_qsvm(x_padded, y, n_qubits, mrValue, featureMap, featureMapType)
