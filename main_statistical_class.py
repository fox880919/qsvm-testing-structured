...
class MainStatisticalClass:
    ...
    def run_qsvm_with_kfold(x_padded, y, mrNumber, n_qubits, mrValue, featureMap):
    
        print(f"\nRunning evaluation with mrValue = {mrValue}, mrNumber: {mrNumber}")
        ...
        if mrValue == 1.0:
            ...
            x_data_to_use, y = MyMetamorphicRelations.useMetamorphicRelation(x_padded, y, mrNumber, 2)

        else:
            print(f'MainStatisticalClass -  run_qsvm_with_kfold, else: mrNumber = {mrNumber}, mrValue{mrValue}')

            x_data_to_use, y = MyMetamorphicRelations.useMetamorphicRelation(x_padded, y, mrNumber, mrValue)
        ...
        for train_index, test_index in kf.split(x_data_to_use):
        ...
        print(f"\n{'='*15} Cross-Validation Summary (mrValue={mrValue}) {'='*15}")
