...
class FeatureMap:
    ...
    def quantum_angle_embedding(x1, x2, n_qubits):
        ...
        if MyParameters.reverseWires == True:
            ...
            #mutation #11 start
            qml.adjoint(qml.AngleEmbedding(features=x2,wires=list(reversed(range(n_qubits))), rotation='Z'))
            #mutation #11 end
            ...
            #mutation #11 start
            qml.AngleEmbedding(features=x1, wires=range(n_qubits), rotation='Z')
            #mutation #11 end
