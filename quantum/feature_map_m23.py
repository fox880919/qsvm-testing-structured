...
class FeatureMap:
    ...
    def quantum_amplitude_embedding(x1, x2, n_qubits):
        ...
        if MyParameters.reverseWires == True:
            ...
            qml.AmplitudeEmbedding(features=x_nonlinear, wires=range(n_qubits), normalize=True)
    ...
    def quantum_angle_embedding(x1, x2, n_qubits):
        ...
        if MyParameters.reverseWires == True:
            ...
            qml.AngleEmbedding(features=x_nonlinear, wires=range(n_qubits), rotation='Y')
