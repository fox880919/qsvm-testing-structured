...
class QKernel:
    ...
    def getFeaturesAndNqubits(self, x_normalized, featureMap):
        ...
        print(f'q_kernel, DefaultParameters.amplitudeNQubits: {MyParameters.amplitudeNQubits}')
        print(f'q_kernel, DefaultParameters.angleNQubits: {MyParameters.angleNQubits}')
