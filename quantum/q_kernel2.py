...
class QKernel:
    ...
    def getFeaturesAndNqubits(self, x_normalized):
        ...
        DefaultParameters.amplitudeNQubits = n_qubits
        DefaultParameters.angleNQubits = n_qubits

        # print(f'DefaultParameters.amplitudeNQubits): {DefaultParameters.amplitudeNQubits}')
        # print(f'DefaultParameters.angleNQubits): {DefaultParameters.angleNQubits}')
